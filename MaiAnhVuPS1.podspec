...
Pod::Spec.new do |s|
  s.name             = 'MaiAnhVuPS1'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MaiAnhVuPS1.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/maianhvu/MaiAnhVuPS1'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'maianhvu' => 'me@maianhvu.com' }
  s.source           = { :git => 'https://github.com/maianhvu/MaiAnhVuPS1.git', :tag => s.version.to_s }
